...
function createEarth() {
    createSphere(-7, -7, 0, 7);
    objectsList[1].mesh.material.map = THREE.ImageUtils.loadTexture('earth.jpg');
    
    createSphere(7, 7, 0, 7);
    objectsList[2].mesh.material.map = THREE.ImageUtils.loadTexture('checkerboard.png');
}
